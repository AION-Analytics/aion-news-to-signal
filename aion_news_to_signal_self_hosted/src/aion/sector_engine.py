...
from .taxonomy_pipeline import TaxonomyPipeline
...
class SectorPropagationEngine:
    def __init__(
        self,
        taxonomy_path: Path,
        cause_effect_rules_path: Path,
        sector_order_path: Path,
        historical_labeled_path: Path | None = None,
    ) -> None:
        ...
        self.history = EventHistoryModel(historical_labeled_path) if historical_labeled_path else EventHistoryModel(Path("__missing__.csv"))
