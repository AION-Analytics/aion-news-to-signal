...
from .sector_engine import SectorPropagationEngine


ALIGNED_DAILY: Path | None = None
...
def build_hypergraph() -> dict[str, dict[str, float]]:
    if ALIGNED_DAILY is None:
        raise RuntimeError("ALIGNED_DAILY path is not configured")
